...
export default MultiSelectComponent.extend(TagsMixin, {
  ...
  modifyNoSelection() {
    if (this.selectKit.options.minimum > 0) {
      return this.defaultItem(
        null,
        I18n.t("tagging.choose_for_node_required", {
          count: this.selectKit.options.minimum,
        })
      );
    } else {
      return this.defaultItem(null, I18n.t("tagging.choose_for_node"));
    }
  },
  ...
  search(filter) {
    ...
    return this.searchTags("/node_tags/filter/search", data, this._transformJson);
  },
